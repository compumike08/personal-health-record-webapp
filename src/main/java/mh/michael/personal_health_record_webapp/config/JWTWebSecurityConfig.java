...
public class JWTWebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  public JWTWebSecurityConfig(
    ...
    this.jwtUnAuthorizedResponseAuthenticationEntryPoint =
  ...
  public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
    auth.userDetailsService(databaseAuthUserDetailsService);
  }
  ...
  public void configure(WebSecurity webSecurity) {
    webSecurity
      ...
      .antMatchers(HttpMethod.POST, "/api/registerUser")
      .antMatchers(HttpMethod.POST, "/api/sendForgotPasswordEmail")
    ...
    if (activeProfile.equals("dev")) {
      webSecurity.ignoring().antMatchers("/h2-console/**/**"); //Should not be in Production!
    }
  }
}
