...
public class AuthorizationUtil {
    ...
    public AuthorizationUtil(PatientRepository patientRepository, UserRepository userRepository) {
    ...
    public Patient checkUserAuthorizationForPatient(UUID patientUuid, UUID currentUserUuid) {
